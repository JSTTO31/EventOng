<template>
    <div class="h-100 pb-5" >
        ...
        <div class="container" >
            <v-card flat color="grey-lighten-4" class="d-flex bg-transparent font-weight-medium">
            ...
            <v-hover v-for="(attendee, index) in event.event_attendees" v-slot="{props, isHovering}">
                <v-card @click="$inertia.visit($route('inboxes.index', {attendee_id: attendee.id}))" class="rounded-0 pa-5 d-flex" :style="'z-index:' + (100 - index)" style="cursor: pointer;" v-bind="props" :elevation="isHovering ? 5 : 0">
                    <v-col class="text-center" cols="3">
                    ...
                    <v-col cols="2" class="text-center">
                        <v-chip class="text-capalize px-5" variant="elevated">Paid</v-chip>
                    </v-col>
                    ...
                    <v-col class="text-center" cols="2">
                        <v-btn flat class="rounded-0" color="black">Notify</v-btn>
                    </v-col>
                </v-card>
            </v-hover>
            <v-card flat color="grey-lighten-4" class="d-flex bg-transparent font-weight-medium">
